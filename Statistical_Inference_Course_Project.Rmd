...
In according to CLT, if the sample size is large enough, the distribution of it approximates the normal distribution with same mean with the population and variance 'population variance/sample size'.
